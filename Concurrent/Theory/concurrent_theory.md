...
## Parallel
----
> Parallelism is an optimization. Before optimizing, always vave actual performance requirements and eliable performance measurements.

<br>


### NQ Model
Need $$NQ > 10,000$$ to have a chance for parallel speedup, where _N_ is the number of data items and _Q_ is the amount of work per item.
...
* Benchmark in 8-core i7, Java SE 8, Linux: `Stream.of(int[]).sum()` vs `Stream.of(Integer[]).sum()`:
...
<p align="center">
  <img src="./Images/parallel_locality.png" width="400" />
</p>
